                        ...
                        <fieldset>
                            <select>
                              <option value="">MARCAS</option>
                                <?php $termz = $wp_query->queried_object; ?>
                                <?php foreach ($marcas as $marca):
                                $marcaName = strtoupper($marca->name);
                                ?>
                              <option value=".<?php echo $marca->slug; ?>" <?php if ($marca->slug == $termz->slug ){echo "selected";}else{} ?> ><?php echo $marcaName; ?></option>
                                <?php endforeach; ?>
                            </select>
                          </fieldset>
...
<?php get_footer(); ?>
    ...
    <?php
        $termz1 = $wp_query->queried_object;
        $termzSlug = $termz1->slug;
    ?>
   <script type="text/javascript">
          $(document).ready(function(){

            var filterClass = "<?php print('.'.$termzSlug); ?>";
            $('#Container').mixItUp({
                load: {
                  filter: filterClass
                },
